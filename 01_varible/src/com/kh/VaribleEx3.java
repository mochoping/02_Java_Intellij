...
public class VaribleEx3 {
    public static void main(String[] args) {
        ...
        *
        ...
        //byte -128 ~127 290을 강제로 넣을 예정
        byte result1 = (byte) num1; // int -> byte 큰값을 작은 값으로 강제 형변환

        System.out.println(num1);
        System.out.println(result1);

        // 강제 형변환을 진행할 때는 리터럴 숫자 앞에 큰 -> 작은것으로 변할
        // 자료형을 () 이용해서 표기
        ...
        // 숫자 맨앞에 0이 붙으면 0을 제외한 수만 표기되거나
        // 표준 숫자 방법 10진수에서 8진수로 변환
    }
}
