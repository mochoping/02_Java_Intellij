...
public class ScannerEx1 {
    public static void main(String[] args) {
        /* Scanner 클래스
           ...
           - Scanner.next() : 단어 (string) 1개 입력 공백 문자 입렧기 입력 종료
           ...
           - Scanner.nextDouble() : 실수 1개 입력
            ...
            // 1. 클래스 위 import 구문 작성

            //2. import 한 Scanner 클래스를 이용해서 Scanner 객채 생성
         ...
         */
         ...
         // console 창에서 어떤것을 입력해야하는지 입력창 표기를 위한 print작성
        System.out.print("정수 입력: ");
        int num1 = sc.nextInt(); // 다음 입력된 정수를 얻어와 num1에 대입
        System.out.print("num1에서 가져온 정수는 : "+num1);

        System.out.print("정수입력 2 : ");
        int num2 = sc.nextInt();// 정수 입력 2가 나온다음 입력된 정수를 얻어와 num2 대입
        ...
        System.out.print("단어를 2가지 입력하세요 : "); //포도 오렌지 입력후 enter
        String 단어1 = sc.next();
        String 단어2 = sc.next();
